  ...
  async getProductsTable(query: any) {
    try {
      ...
      const set: TableSet = {
        columns: {
          id: ['products.id', true],
          product: ['COALESCE(products.product_id, products.id::text) AS product', true],
          product_category: ['COALESCE(categories.name, \'General\') AS product_category', true],
    ...
    try {
      ...
      const set: TableSet = {
        columns: {
          ...
          description: ['product_banner.description', true],
          discount_text: ['product_banner.discount_text', true],
          banner_type: ['product_banner.banner_type', true],
          category_id: ['product_banner.category_id', true],
          is_popup: ['product_banner.is_popup', true],
          action_type: ['product_banner.action_type', true],
          action_value: ['product_banner.action_value', true],
          cta_label: ['product_banner.cta_label', true],
          background_color: ['product_banner.background_color', true],
