...
export class CatalogShowAddService {
  ...
  variantFields(
    ...
    return [
      ...
      { name: 'purchase_price', label: 'Purchase Price (Cost / COGS)', type: 'number', required: false, width: 'third', group: 'Pricing & Value', placeholder: '0.00', validation: { min: 0, max: 999999 }, },
      { name: 'discount', label: 'Discount % (Auto-calculated)', type: 'number', required: false, width: 'third', group: 'Pricing & Value', placeholder: '0%', disabled: true },
