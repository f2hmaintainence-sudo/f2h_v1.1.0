...
// Tables with no `deleted_at` column: the generic query builder must not
// append a soft-delete filter for these. Derived from the live schema —
// every other table carries `deleted_at` and is filtered by default.
export const AVOID_DELETED_AT = [
  ...
  'coupon_redemptions',
  'delivery_baskets',
  'delivery_partner_bank_accounts',
  'delivery_partner_documents',
  'delivery_partner_locations',
  'delivery_partner_redeem_requests',
