...
--
-- Name: breakdown_incidents; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.breakdown_incidents (
    id bigint NOT NULL,
    incident_id character varying(50) NOT NULL,
    delivery_partner_id character varying(100) NOT NULL,
    ...
    reassigned_partner_id character varying(100),
    reassigned_partner_name character varying(255),
    handover_otp character varying(6),
...
--
-- Name: breakdown_incidents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.breakdown_incidents_id_seq OWNED BY public.breakdown_incidents.id;
...
--
-- Name: customer_variant_prices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.customer_variant_prices (
    id bigint NOT NULL,
    customer_id character varying(30) NOT NULL,
    product_variant_id character varying(30) NOT NULL,
...
--
-- Name: customer_variant_prices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.customer_variant_prices_id_seq OWNED BY public.customer_variant_prices.id;
...
--
-- Name: dispatch_balances; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dispatch_balances (
    id bigint NOT NULL,
    delivery_partner_id character varying(30) NOT NULL,
    product_variant_id character varying(30) NOT NULL,
    run_date date NOT NULL,
    delivery_slot character varying(30) NOT NULL,
    dispatched_qty numeric(10,2) DEFAULT 0 NOT NULL,
    delivered_qty numeric(10,2) DEFAULT 0 NOT NULL,
    returned_qty numeric(10,2) DEFAULT 0 NOT NULL,
    damaged_qty numeric(10,2) DEFAULT 0 NOT NULL,
    balance_qty numeric(10,2) DEFAULT 0 NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    deleted_at timestamp without time zone
);
...
--
-- Name: dispatch_balances_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.dispatch_balances_id_seq OWNED BY public.dispatch_balances.id;


--
-- Name: dispatch_plan_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dispatch_plan_items (
    id integer NOT NULL,
    dispatch_plan_id character varying(30) NOT NULL,
...
CREATE TABLE public.dispatch_plans (
    id integer NOT NULL,
    dispatch_number character varying(30) DEFAULT (gen_random_uuid())::character varying(30) NOT NULL,
    ...
    dispatched_by character varying,
    dispatched_at timestamp with time zone,
    received_by character varying,
    received_at timestamp with time zone,
    vehicle_number character varying(30) DEFAULT NULL::character varying,
    notes text,
    created_by character varying,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    deleted_at timestamp without time zone,
    CONSTRAINT dispatch_plans_status_check CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'approved'::character varying, 'picking'::character varying, 'dispatched'::character varying, 'in_transit'::character varying, 'received'::character varying, 'cancelled'::character varying])::text[])))
);


--
-- Name: dispatch_requirements; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dispatch_requirements (
    id bigint NOT NULL,
    run_id character varying(30) NOT NULL,
    run_date date NOT NULL,
    delivery_slot character varying(30) NOT NULL,
    delivery_partner_id character varying(30) NOT NULL,
    product_variant_id character varying(30) NOT NULL,
    required_quantity numeric(10,2) DEFAULT 0 NOT NULL,
    unit character varying(20) DEFAULT 'pcs'::character varying,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    deleted_at timestamp without time zone
...
--
-- Name: dispatch_requirements_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.dispatch_requirements_id_seq OWNED BY public.dispatch_requirements.id;
...
--
-- Name: order_containers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.order_containers (
    id bigint NOT NULL,
...
--
-- Name: order_containers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.order_containers_id_seq OWNED BY public.order_containers.id;
...
--
-- Name: breakdown_incidents id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.breakdown_incidents ALTER COLUMN id SET DEFAULT nextval('public.breakdown_incidents_id_seq'::regclass);
...
--
-- Name: customer_variant_prices id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_variant_prices ALTER COLUMN id SET DEFAULT nextval('public.customer_variant_prices_id_seq'::regclass);
...
--
-- Name: dispatch_balances id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_balances ALTER COLUMN id SET DEFAULT nextval('public.dispatch_balances_id_seq'::regclass);


--
-- Name: dispatch_requirements id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_requirements ALTER COLUMN id SET DEFAULT nextval('public.dispatch_requirements_id_seq'::regclass);
...
--
-- Name: order_containers id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_containers ALTER COLUMN id SET DEFAULT nextval('public.order_containers_id_seq'::regclass);
...
--
-- Name: breakdown_incidents breakdown_incidents_incident_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.breakdown_incidents
    ADD CONSTRAINT breakdown_incidents_incident_id_key UNIQUE (incident_id);


--
-- Name: breakdown_incidents breakdown_incidents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.breakdown_incidents
    ADD CONSTRAINT breakdown_incidents_pkey PRIMARY KEY (id);
...
--
-- Name: customer_variant_prices customer_variant_prices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_variant_prices
    ADD CONSTRAINT customer_variant_prices_pkey PRIMARY KEY (id);
...
--
-- Name: dispatch_balances dispatch_balances_delivery_partner_id_product_variant_id_ru_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_balances
    ADD CONSTRAINT dispatch_balances_delivery_partner_id_product_variant_id_ru_key UNIQUE (delivery_partner_id, product_variant_id, run_date, delivery_slot);


--
-- Name: dispatch_balances dispatch_balances_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_balances
    ADD CONSTRAINT dispatch_balances_pkey PRIMARY KEY (id);


--
-- Name: dispatch_plan_items dispatch_plan_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_plan_items
    ADD CONSTRAINT dispatch_plan_items_pkey PRIMARY KEY (id);


--
-- Name: dispatch_plans dispatch_plans_dispatch_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_plans
    ADD CONSTRAINT dispatch_plans_dispatch_number_key UNIQUE (dispatch_number);
...
--
-- Name: dispatch_requirements dispatch_requirements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_requirements
    ADD CONSTRAINT dispatch_requirements_pkey PRIMARY KEY (id);


--
-- Name: dispatch_requirements dispatch_requirements_run_id_product_variant_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_requirements
    ADD CONSTRAINT dispatch_requirements_run_id_product_variant_id_key UNIQUE (run_id, product_variant_id);
...
--
-- Name: order_containers order_containers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_containers
    ADD CONSTRAINT order_containers_pkey PRIMARY KEY (id);
...
--
-- Name: customer_variant_prices uq_customer_variant_price; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_variant_prices
    ADD CONSTRAINT uq_customer_variant_price UNIQUE (customer_id, product_variant_id);
...
--
-- Name: idx_breakdown_incidents_delivery_partner_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_breakdown_incidents_delivery_partner_id ON public.breakdown_incidents USING btree (delivery_partner_id);


--
-- Name: idx_breakdown_incidents_run_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_breakdown_incidents_run_id ON public.breakdown_incidents USING btree (run_id);
...
--
-- Name: idx_customer_variant_prices_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_customer_variant_prices_customer ON public.customer_variant_prices USING btree (customer_id);


--
-- Name: idx_customer_variant_prices_price; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_customer_variant_prices_price ON public.customer_variant_prices USING btree (special_price);


--
-- Name: idx_customer_variant_prices_variant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_customer_variant_prices_variant ON public.customer_variant_prices USING btree (product_variant_id);
...
--
-- Name: idx_dispatch_balances_boy_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_balances_boy_date ON public.dispatch_balances USING btree (delivery_partner_id, run_date);


--
-- Name: idx_dispatch_balances_delivery_partner_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_balances_delivery_partner_id ON public.dispatch_balances USING btree (delivery_partner_id);
...
--
-- Name: idx_dispatch_plan_items_plan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_plan_items_plan ON public.dispatch_plan_items USING btree (dispatch_plan_id);


--
-- Name: idx_dispatch_plans_branch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_plans_branch ON public.dispatch_plans USING btree (target_branch_id, dispatch_date);
...
CREATE INDEX idx_dispatch_plans_status ON public.dispatch_plans USING btree (status) WHERE ((status)::text <> ALL ((ARRAY['received'::character varying, 'cancelled'::character varying])::text[]));


--
-- Name: idx_dispatch_plans_warehouse; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_plans_warehouse ON public.dispatch_plans USING btree (source_warehouse_id, dispatch_date);


--
-- Name: idx_dispatch_requirements_boy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_requirements_boy ON public.dispatch_requirements USING btree (delivery_partner_id);


--
-- Name: idx_dispatch_requirements_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_requirements_date ON public.dispatch_requirements USING btree (run_date);


--
-- Name: idx_dispatch_requirements_delivery_partner_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_requirements_delivery_partner_id ON public.dispatch_requirements USING btree (delivery_partner_id);


--
-- Name: idx_dispatch_requirements_run; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_requirements_run ON public.dispatch_requirements USING btree (run_id);


--
-- Name: idx_dispatch_requirements_run_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispatch_requirements_run_id ON public.dispatch_requirements USING btree (run_id);
...
--
-- Name: customer_variant_prices customer_variant_prices_product_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_variant_prices
    ADD CONSTRAINT customer_variant_prices_product_variant_id_fkey FOREIGN KEY (product_variant_id) REFERENCES public.product_variants(variant_id) ON DELETE CASCADE;
...
--
-- Name: dispatch_plan_items dispatch_plan_items_dispatch_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_plan_items
    ADD CONSTRAINT dispatch_plan_items_dispatch_plan_id_fkey FOREIGN KEY (dispatch_plan_id) REFERENCES public.dispatch_plans(dispatch_number) ON DELETE CASCADE;


--
-- Name: dispatch_requirements dispatch_requirements_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_requirements
    ADD CONSTRAINT dispatch_requirements_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.delivery_runs(run_id) ON DELETE CASCADE;
...
--
-- Name: breakdown_incidents fk_breakdown_incidents_run_id_delivery_runs; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.breakdown_incidents
    ADD CONSTRAINT fk_breakdown_incidents_run_id_delivery_runs FOREIGN KEY (run_id) REFERENCES public.delivery_runs(run_id) ON DELETE CASCADE;
...
--
-- Name: dispatch_requirements fk_dispatch_requirements_run_id_delivery_runs; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispatch_requirements
    ADD CONSTRAINT fk_dispatch_requirements_run_id_delivery_runs FOREIGN KEY (run_id) REFERENCES public.delivery_runs(run_id) ON DELETE CASCADE;
