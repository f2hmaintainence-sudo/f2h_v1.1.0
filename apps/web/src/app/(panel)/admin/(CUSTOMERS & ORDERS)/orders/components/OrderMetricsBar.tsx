...
const STATUS_CARDS = [
  ...
  { key: 'pending', label: 'Pending', statusVal: 'PENDING', icon: Clock, bg: 'bg-amber-50 text-amber-900 border-amber-200' },
  { key: 'confirmed', label: 'Confirmed', statusVal: 'CONFIRMED', icon: CheckCircle2, bg: 'bg-teal-50 text-teal-900 border-teal-200' },
  { key: 'packed', label: 'Packed', statusVal: 'PACKED', icon: Package, bg: 'bg-indigo-50 text-indigo-900 border-indigo-200' },
