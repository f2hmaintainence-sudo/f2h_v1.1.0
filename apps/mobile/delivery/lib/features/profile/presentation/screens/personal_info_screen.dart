              ...
              children: [
                ...
                _buildCard([
                  ...
                  _buildDetailRow(
                    ...
                    label: 'Date of Birth',
                    value: (p.dateOfBirth != null && p.dateOfBirth!.isNotEmpty) ? p.dateOfBirth!.split('T')[0] : '—',
                  ),
                  _buildDetailRow(
                  ...
                  _buildDetailRow(
                    ...
                    iconColor: const Color(0xFF16A34A),
                    label: 'Address',
                    value: (p.residentialAddress != null && p.residentialAddress!.isNotEmpty) ? p.residentialAddress! : '—',
                    isLast: true,
                  ),
                ]),
                ...
                _buildCard([
                  _buildDetailRow(
                    ...
                    iconColor: const Color(0xFF16A34A),
                    label: 'Contact Name',
                    value: (p.emergencyContact != null && p.emergencyContact!.isNotEmpty) ? p.emergencyContact! : '—',
                  ),
                  _buildDetailRow(
                    icon: Icons.phone_android_rounded,
                    iconBg: const Color(0xFFDCFCE7),
                    iconColor: const Color(0xFF16A34A),
                    label: 'Emergency Mobile Number',
                    value: (p.emergencyContactNumber != null && p.emergencyContactNumber!.isNotEmpty) ? p.emergencyContactNumber! : '—',
                    isLast: true,
                  ),
                ]),
              ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.roboto(
                        fontSize: 13.5,
                        fontWeight: (value.isEmpty || value == '—' || value == 'Not set') ? FontWeight.w500 : FontWeight.w700,
                        color: (value.isEmpty || value == '—' || value == 'Not set') ? const Color(0xFF94A3B8) : const Color(0xFF0F172A),
                      ),
                    ),
                  ],
                ),
