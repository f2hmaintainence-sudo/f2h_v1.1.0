...
class Subscription {
  ...
  Subscription copyWith({
    ...
    List<SubscriptionScheduleModel>? weeklySchedules,
    List<SubscriptionCustomDateModel>? customDates,
    List<SubscriptionPauseModel>? pauses,
    List<SubscriptionBillModel>? bills,
    ...
    return Subscription(
      ...
      pauseFromDate: pauseFromDate ?? this.pauseFromDate,
      pauseToDate: pauseToDate ?? this.pauseToDate,
