...
class ApiEndpoints {
  ...
  static String subscriptionCalendarEnhanced(String id) => '$_customer/subscriptions/$id/calendar';
  static String subscriptionAddItem(String id) => '$_customer/subscriptions/$id/add-item';
  static String subscriptionAddress(String id) => '$_customer/subscriptions/$id/address';
