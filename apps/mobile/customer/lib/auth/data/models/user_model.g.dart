...
UserModel _userModelDeserialize(
  ...
  final object = UserModel(
    ...
    mustChangePassword: reader.readBoolOrNull(offsets[2]) ?? false,
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> cachedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByMustChangePassword() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByMustChangePassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mustChangePassword', Sort.asc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByMustChangePassword() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, bool, QQueryOperations> mustChangePasswordProperty() {
    return QueryBuilder.apply(this, (query) {
